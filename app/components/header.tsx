                ...
                >
                    <div style={{color: 'white', paddingLeft: 10, paddingTop: 20}}>
                        ...
                        }, 
                        {
                            title: 'Contact Us',
                            to: '/contact'
                        }].map(({title, to}, key) => <Link key={key} href={to} style={{color: 'white', fontSize: '1.3em', display: 'block', marginBottom: 20}}>{title}</Link>)}
                        
                    </div>
            </Drawer>
            {dimensions.width > PHONE_BREAKPOINT &&<div style={{marginRight: 20, marginLeft: 20}}>
                <Link href='/'><img alt='Codetribe logo' src='/images/mlab.png' style={{maxHeight: 40, marginRight: 40}} /></Link>
            </div>}
            ...
            {dimensions.width <= PHONE_BREAKPOINT && (
                <div style={{padding: 10, width: '100%', background: 'white', display: 'flex', alignItems: 'center', position: 'relative'}}>
                    ...
                    <div style={{flexGrow: 1, display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
                        <Link href='/'><img alt='ReactFire logo' src='/images/mlab.png' style={{height: 40, marginRight: 40, maxHeight: 40}} /></Link>
                    </div>
