...
export default ({ params }: { params: { id: string, lessonId: string, chapterId: string }}) => {
        ...
        >
          <Stack flex={1}>
            ...
            >
              ...
              {currentLesson && !currentLesson.isQuiz && (
                <div>
                  <iframe width="100%" height="700" allowFullScreen src={currentLesson?.videoUrl} frameBorder={0} title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"></iframe>
                  <Divider />
          ...
          >
            <Stack p={2}>
              ...
              <Link href={'mainSlug'}><h2 style={{color: '#97CA42', marginBottom: 0}}>{currentLesson?.title}</h2><span style={{color: '#afafaf'}}>{totalDuration}</span></Link>
            ...
            >
              {course!.chapters.map(chapter => {
                ...
                const chapterTotalDurationText = DurationHelper.secondsToText(
                  ...
                  <Collapse.Panel
                    ...
                    header={
                      <Stack>
                        <Typography
                          sx={{
                            color: chapter.key === currentLesson.chapterKey ? "#97CA42" : "#606060",
                          }}
                          variant="subtitle1"
                        ...
                        return (
                          ...
                          >
                            ...
                            <Link
                              ...
                              style={{
                                color: "#606060",
                                fontWeight: currentLesson.key === lesson.key ? "bold" : "normal",
                              }}
                            >
                              {lesson.title} 
                              {/* (
